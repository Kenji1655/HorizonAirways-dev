...
CREATE TABLE AERONAVES(
    ...
    CONSTRAINT CK_FABRICANTE_VALIDO CHECK (FABRICANTE IN ('Airbus', 'Boeing', 'Embraer')),
    CONSTRAINT CK_ANO_VALIDO CHECK (ANO_FABRICACAO BETWEEN 1990 AND 2023),
    CONSTRAINT CK_TOTAL_ASSENTOS CHECK (TOTAL_ASSENTOS BETWEEN 100 AND 1000),
...
CREATE TABLE TRECHOS(
    ...
    CONSTRAINT FK_ORIGEM_AEROPORTO FOREIGN KEY (ORIGEM) REFERENCES AEROPORTOS(CODIGO),
    CONSTRAINT FK_DESTINO_AEROPORTO FOREIGN KEY (DESTINO) REFERENCES AEROPORTOS(CODIGO),
    CONSTRAINT FK_AERONAVE FOREIGN KEY(AERONAVE) REFERENCES AERONAVES(CODIGO)
);
...
INSERT INTO TRECHOS (
    ...
    SEQ_TRECHOS.NEXTVAL,
    'Campinas(vcp) - Fort Lauderdale(FLL)',
    1,
    3,
    4
);
...
INSERT INTO TRECHOS (
    ...
    SEQ_TRECHOS.NEXTVAL,
    'Fort Lauderdale(FLL) - Campinas(vcp)',
    3,
    1,
    4
);
...
CREATE TABLE VOOS(
    ...
    CONSTRAINT FK_TRECHO FOREIGN KEY (TRECHO) REFERENCES TRECHOS(CODIGO)
);
